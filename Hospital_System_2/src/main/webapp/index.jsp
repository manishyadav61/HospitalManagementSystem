...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hos4.jpg" class="d-block w-100" alt="..." height="600px">
    </div>
    <div class="carousel-item">
      <img src="img/hos8.jpg" class="d-block w-100" alt="..." height="600px">
...
<div class="container p-3">
	...
	<div class="row">
				...
				<div class="col-md-6">
					<div class="car paint-card">
						<div class="card-body">
							...
							<p>Lorem ipsum dolor sit amet,consectulkdlkjd</p>
						</div>
					</div>
				</div>
				<div class="col-md-6">
		...
		<div class="col-md-4">
			<img alt="" src="img/hos6.jpg" height="300px" width="400px">
		</div>
	</div>
</div>
<hr>
		...
		<div class="col-md-3">
			<div class="card paint-card">
				<div class="card-body text-center">
					...
					<p class="fw-bold fs-5">Samauni Simi</p>
